...
public class DashboardController implements Initializable, BaseController {
    ...
    public void onNavigatedTo() {
        // Bersihkan dulu agar tidak double-render saat dari cache
        ...
        if (dataGrafik.isEmpty()) {
            ...
            chartIPS.setVisible(true);
            chartIPS.setManaged(true);
            lblKosong.setVisible(false);
            lblKosong.setManaged(false);
    ...
    private void muatTabelDetail(Map<Integer, Double> data) {
        ...
        data.forEach((sem, ips) -> {
            ...
            Label lIPS = buatLabel(KalkulatorNilai.formatNilai(ips),  80, warna,     true);
            ...
            Label lKet = buatLabel(keteranganIPS(ips), 130, warna, false);
